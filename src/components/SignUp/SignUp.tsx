            ...
            <Fragment>
                <div className={classes.container}>
                    ...
                    <form className={classes.formContainer}>
                        ...
                        <div className={classes.buttonRow}>
                            <IconButton onClick={this.signUpWithGoogle} data-test="sign-up-with-google">
                                <GoogleIcon />
                            </IconButton>
                            <IconButton onClick={this.signUpWithTwitter} data-test="sign-up-with-twitter">
                                <TwitterIcon />
                            </IconButton>
                            <IconButton onClick={this.signUpWithFacebook} data-test="sign-up-with-facebook">
                                <FacebookIcon />
                            </IconButton>
                        </div>
                    </form>
